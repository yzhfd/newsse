...
$_LANG['cfg_name']['integral_exc'] = '积分兑换比例';
$_LANG['cfg_name']['exp_buy'] = '经验值购买比例';
$_LANG['cfg_name']['exp_sell'] = '经验值卖出比例';
$_LANG['cfg_name']['exp_exchange'] = '经验值兑换比例';
...
$_LANG['cfg_name']['message_board'] = '是否启用我要提意见功能';
...
$_LANG['cfg_name']['use_money'] = '是否使用金币';
$_LANG['cfg_name']['money_per'] = '金币与人民币比例';
...
$_LANG['cfg_desc']['integral_exc'] = '每100个积分可以兑换多少个金币';
$_LANG['cfg_desc']['exp_buy'] = '每1个经验值需要多少人民币购买';
$_LANG['cfg_desc']['exp_sell'] = '每1个经验值可以卖多少人民币';
$_LANG['cfg_desc']['exp_exchange'] = '每1个金币需要多少个经验值和人民币来兑换';
...
$_LANG['cfg_desc']['money_per'] = '当使用金币进行支付时，一个金币相当于多少人民币和经验值';
...
$_LANG['cfg_range']['use_money']['1'] = '使用';
$_LANG['cfg_range']['use_money']['0'] = '不使用';
