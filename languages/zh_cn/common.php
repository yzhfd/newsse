...
$_LANG['goods_virtual'] = '金币';
$_LANG['goods_newer'] = '新旧程度：';
$_LANG['goods_standard'] = '型号规格：';
$_LANG['goods_flaw'] = '瑕疵说明：';
$_LANG['is_local'] = '同城交易：';
$_LANG['local_area'] = '同城交易地区：';
...
$_LANG['message_image'] = '上传图片';
$_LANG['message_time'] = '时间';
...
$_LANG['message_submit_done'] = '留言成功';
$_LANG['message_board_close'] = "暂停留言板功能";
$_LANG['upload_file_limit'] = '文件大小超过了限制 %dKB';
$_LANG['message_list_lnk'] = '返回留言列表';
$_LANG['supply_list_lnk'] = '返回留言列表';
$_LANG['supply_submit_wait'] = '您的申请已成功发表, 请等待管理员的审核!';
$_LANG['supply_submit_done'] = '申请成功';

/*我要供货*/
$_LANG['supply_board'] = "申请供货记录";
$_LANG['post_supply'] = "我想要供货";
$_LANG['user_phone'] = '联系电话';
$_LANG['supply_title'] = '标题';
$_LANG['supply_image'] = '上传图片';
$_LANG['supply_time'] = '申请时间';
$_LANG['reply_time'] = '回复时间';
$_LANG['shop_owner_reply'] = '店主回复';
$_LANG['supply_content'] = '详细描述';
$_LANG['supply_phone'] = '联系方式';
$_LANG['supply_status'] = '状态';
$_LANG['supply_handler'] = '操作';
$_LANG['supply_get'] = '收获';
$_LANG['supply_extra'] = '备注';
$_LANG['supply_anonymous'] = '匿名供货';
$_LANG['supply_board_js']['spy_empty_email'] = '请输入您的电子邮件地址';
$_LANG['supply_board_js']['spy_error_email'] = '电子邮件地址格式不正确';
$_LANG['supply_board_js']['spy_title_empty'] = '标题为空';
$_LANG['supply_board_js']['spy_phone_empty'] = '联系方式为空';
$_LANG['supply_board_js']['spy_content_empty'] = '详细描述为空';
$_LANG['supply_board_js']['spy_captcha_empty'] = '验证码为空';
$_LANG['supply_board_js']['spy_title_limit'] = '标题不能超过200个字';
$_LANG['supply_submit_wait'] = '您已成功提交申请, 请等待管理员的审核!';
$_LANG['supply_submit_done'] = '供货申请成功';
$_LANG['supply_board_close'] = "暂停供货功能";
$_LANG['upload_file_limit'] = '文件大小超过了限制 %dKB';
$_LANG['supply_list_lnk'] = '返回申请列表';
$_LANG['label_supply']="我的供货记录";

/*我的同城销售记录*/
$_LANG['label_goods_sell'] = "我的同城销售";
$_LANG['sell_area'] = '地点';
$_LANG['add_time'] = '日期';
$_LANG['goods_name'] = '商品名称';
$_LANG['sell_phone'] = '联系方式';
$_LANG['sell_status'] = '状态';
$_LANG['sell_handler'] = '操作';
$_LANG['sell_get'] = '收获';
$_LANG['sell_extra'] = '备注';
