...
$_LANG['label_order'] = '我的购买';
$_LANG['label_record'] = '我的供货记录';
$_LANG['label_sell'] = '我的同城出售';
$_LANG['label_address'] = '收货地址';
$_LANG['label_message'] = '我的留言板';
...
$_LANG['surplus_type_2'] = '转让';
$_LANG['surplus_type_3'] = '我要买经验值';
$_LANG['surplus_type_3_1'] = '买经验值';
$_LANG['surplus_type_3_2'] = '卖经验值';
$_LANG['surplus_type_3_3'] = '经验值兑换';
$_LANG['surplus_type_4'] = '我要卖经验值';
$_LANG['surplus_type_5'] = '我要兑换金币';
$_LANG['deposit_money'] = '充值金额';
$_LANG['tranfer_value'] = '转让经验值';
$_LANG['exp_value_buy'] = '买经验值数';
$_LANG['exp_value_exchange'] = '兑换金币数';
$_LANG['exp_exchange_exp']="需要经验值";
$_LANG['exp_exchange_money']="需要人名币";
$_LANG['exp_value_sell'] = '卖经验值数';
$_LANG['exp_sell_money'] = '可获得人名币';
$_LANG['exp_buy_money'] = '需要人名币';
$_LANG['tranfer_to'] = '转给会员';
...
$_LANG['current_exp'] = '您当前的经验值为：';
$_LANG['unit_yuan'] = '元';
$_LANG['for_free'] = '赠品免费';
$_LANG['surplus_amount_error'] = '您要申请提现的金额超过了您现有的余额，此操作将不可进行！';
$_LANG['surplus_exp_error'] = '您要申请转让值超过了您现有的经验值，此操作将不可进行！';
$_LANG['transfer_no_user'] = '您要申请转让的会员账号不存在！';
$_LANG['transfer_to_self']="您不可以申请转让给自己经验值！";
...
$_LANG['message_time'] = '提意见时间';
$_LANG['reply_time'] = '回复时间';
$_LANG['shopman_reply'] = '店主回复';
$_LANG['send_message'] = '发表意见';
$_LANG['message_type'] = '意见类型';
$_LANG['message_content'] = '意见内容';
$_LANG['submit_message'] = '提交意见';
...
$_LANG['add_message_success'] = '发表意见成功';
$_LANG['message_list_lnk'] = '返回意见列表';
$_LANG['msg_title_empty'] = '意见标题为空';
...
$_LANG['message_empty'] = '您现在还没有意见！';
$_LANG['msg_success'] = '您的意见已成功提交！';
$_LANG['confirm_remove_msg'] = '你确实要彻底删除这条意见吗？';
...
$_LANG['exp_use_ruler']="经验值使用规则";
$_LANG['point_to_money']="积分兑换金币的比率";
$_LANG['point_trans_ruler']="积分兑换规则";
$_LANG['user_rank_ruler']="会员级别规则";
$_LANG['order_auto_cancel']="期限24小时内，过时系统将自动取消订单";
?>