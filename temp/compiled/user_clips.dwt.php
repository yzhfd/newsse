     ...
     <div class="box_1">
      <div class="userCenterBox boxCenterList clearfix" style="_height:1%;">
         ...
         <?php if ($this->_var['action'] == 'default'): ?>
          ...
          <?php echo $this->_var['rank_name']; ?> <?php echo $this->_var['next_rank_name']; ?>(<a target="_blank" href="article.php?id=40"><?php echo $this->_var['lang']['user_rank_ruler']; ?>)<br />
          <div class="blank5"></div>
          ...
          <?php echo $this->_var['lang']['your_virtual']; ?>:<?php echo $this->_var['info']['formated_virtual_money']; ?><br />
          ...
          <?php echo $this->_var['lang']['your_integral']; ?>:<?php echo $this->_var['info']['integral']; ?>(<?php echo $this->_var['lang']['point_to_money']; ?>:{},<a target="_blank" href="article.php?id=39"><?php echo $this->_var['lang']['point_trans_ruler']; ?>)</a><br />
           <?php echo $this->_var['lang']['your_exp']; ?>:<?php echo $this->_var['info']['exp_value']; ?>(<a target="_blank" href="article.php?id=38"><?php echo $this->_var['lang']['exp_use_ruler']; ?></a>)<br />
          </div>
...
?>
        ...
        <?php if ($this->_var['action'] == 'supply_list'): ?>
          <h5><span><?php echo $this->_var['lang']['label_supply']; ?></span></h5>
          <div class="blank"></div>
           <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
        <tr align="center">
        <th width="10%" bgcolor="#ffffff"><?php echo $this->_var['lang']['supply_time']; ?></th>
        <th width="15%" bgcolor="#ffffff"><?php echo $this->_var['lang']['supply_content']; ?></th>
        <th width="10%" bgcolor="#ffffff"><?php echo $this->_var['lang']['supply_phone']; ?></th>
        <th width="10%" bgcolor="#ffffff"><?php echo $this->_var['lang']['supply_status']; ?></th>
        <th width="10%" bgcolor="#ffffff"><?php echo $this->_var['lang']['supply_handler']; ?></th>
        <th width="15%" bgcolor="#ffffff"><?php echo $this->_var['lang']['supply_get']; ?></th>
        <th width="10%" bgcolor="#ffffff"><?php echo $this->_var['lang']['supply_extra']; ?></th>
      </tr>
      <?php $_from = $this->_var['supply_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'message');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['message']):
?>
      <tr>
        <td bgcolor="#ffffff"><?php echo $this->_var['message']['msg_time']; ?></td>
        <td bgcolor="#ffffff"><?php echo $this->_var['message']['msg_content']; ?>
                   <?php if ($this->_var['message']['message_img']): ?>
           <div align="right">
           <a href="data/feedbackimg/<?php echo $this->_var['message']['message_img']; ?>" target="_bank" class="f6"><?php echo $this->_var['lang']['view_upload_file']; ?></a>
           </div>
        ...
        <td bgcolor="#ffffff"><?php echo $this->_var['message']['user_phone']; ?></td>
        <td bgcolor="#ffffff"><?php echo $this->_var['message']['msg_status']; ?></td>
        <td bgcolor="#ffffff"><?php if ($this->_var['message']['status'] == '1'): ?><form action="user.php" method="post">
                <input name="inv_no" type="text"/><input type="submit" value="发货"/>
                <input type="hidden" name="act" value="delivery"/>
                <input type="hidden" name="msg_id" value="<?php echo $this->_var['message']['msg_id']; ?>"/>
            </form><?php endif; ?></td>
      ...
      <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
          ...
          <form action="user.php" method="post" enctype="multipart/form-data" name="formMsg" onSubmit="return submitMsg()">
                  <table width="100%" border="0" cellpadding="3">
                    <tr>
                      <td align="right"><?php echo $this->_var['lang']['supply_title']; ?>：</td>
                      <td><input name="msg_title" type="text" size="30" class="inputBg" /></td>
                    </tr>
                    <tr>
                      <td align="right" valign="top"><?php echo $this->_var['lang']['supply_content']; ?>：</td>
                      <td><textarea name="msg_content" cols="50" rows="4" wrap="virtual" class="B_blue"></textarea></td>
                    </tr>
                    <tr>
                      <td align="right"><?php echo $this->_var['lang']['upload_img']; ?>：</td>
                    ...
                    <tr>
                      <td>&nbsp;</td>
                      <td><input type="hidden" name="act" value="act_add_supply" />
                        <input type="submit" value="<?php echo $this->_var['lang']['submit']; ?>" class="bnt_bonus" />
                      </td>
                    </tr>
                    <tr>
         ...
         <?php endif; ?>
           ...
           <?php if ($this->_var['action'] == 'goods_sell'): ?>
          <h5><span><?php echo $this->_var['lang']['label_goods_sell']; ?></span></h5>
          <div class="blank"></div>
           <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
        <tr align="center">
        <th width="10%" bgcolor="#ffffff"><?php echo $this->_var['lang']['sell_area']; ?></th>
        <th width="15%" bgcolor="#ffffff"><?php echo $this->_var['lang']['add_time']; ?></th>
        <th width="10%" bgcolor="#ffffff"><?php echo $this->_var['lang']['goods_name']; ?></th>
        <th width="10%" bgcolor="#ffffff"><?php echo $this->_var['lang']['sell_phone']; ?></th>
        <th width="10%" bgcolor="#ffffff"><?php echo $this->_var['lang']['sell_status']; ?></th>
        <th width="15%" bgcolor="#ffffff"><?php echo $this->_var['lang']['sell_handler']; ?></th>
        <th width="15%" bgcolor="#ffffff"><?php echo $this->_var['lang']['sell_get']; ?></th>
        <th width="10%" bgcolor="#ffffff"><?php echo $this->_var['lang']['supply_extra']; ?></th>
      </tr>
      <?php $_from = $this->_var['local_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'local');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['local']):
?>
      <tr>
        <td bgcolor="#ffffff"><?php echo $this->_var['local']['local_area']; ?></td>
        <td bgcolor="#ffffff"><?php echo $this->_var['local']['add_time']; ?>
        </td>
        <td bgcolor="#ffffff"><?php echo $this->_var['local']['goods_name']; ?></td>
        <td bgcolor="#ffffff"><?php echo $this->_var['local']['mobile_phone']; ?></td>
        <td bgcolor="#ffffff"><?php echo $this->_var['local']['sell_status']; ?></td>
        <td bgcolor="#ffffff"><?php if (! $this->_var['local']['local_status']): ?><a href="user.php?act=complete&goods_id=<?php echo $this->_var['local']['goods_id']; ?>">已交货</a><?php endif; ?>&nbsp;&nbsp;<?php if ($this->_var['local']['is_on_sale']): ?><a href="user.php?act=not_sale&goods_id=<?php echo $this->_var['local']['goods_id']; ?>">下架</a><?php endif; ?></td>
        <td bgcolor="#ffffff"></td>
         <td bgcolor="#ffffff"></td>
      </tr>
      <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
