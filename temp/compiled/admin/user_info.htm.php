...
<table width="100%" >
  ...
  <tr>
    <td class="label"><?php echo $this->_var['lang']['virtual_money']; ?>:</td>
    <td><?php echo $this->_var['user']['formated_virtual_money']; ?> <a href="account_log.php?act=list&user_id=<?php echo $this->_var['user']['user_id']; ?>&account_type=virtual_money">[ <?php echo $this->_var['lang']['view_detail_account']; ?> ]</a> </td>
  </tr>
    <tr>
    <td class="label"><?php echo $this->_var['lang']['exp_value']; ?>:</td>
    <td><?php echo $this->_var['user']['exp_value']; ?> <a href="account_log.php?act=list&user_id=<?php echo $this->_var['user']['user_id']; ?>&account_type=exp_value">[ <?php echo $this->_var['lang']['view_detail_account']; ?> ]</a> </td>
  </tr>
  <tr>
