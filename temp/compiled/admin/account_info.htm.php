...
<table cellspacing="1" cellpadding="3" width="100%">
  ...
  <tr>
    ...
    <tr>
    <td class="label"><?php echo $this->_var['lang']['label_virtual_money']; ?></td>
    <td><select name="add_sub_virtual_money" id="add_sub_virtual_money">
      <option value="1" selected="selected"><?php echo $this->_var['lang']['add']; ?></option>
      <option value="-1"><?php echo $this->_var['lang']['subtract']; ?></option>
    </select>
      <input name="virtual_money" type="text" id="virtual_money" style="text-align:right" value="0" size="10" />
      <?php echo $this->_var['lang']['current_value']; ?><?php echo $this->_var['user']['formated_virtual_money']; ?></td>
  </tr>
   <tr>
    <td class="label"><?php echo $this->_var['lang']['label_exp_value']; ?></td>
    <td><select name="add_sub_exp_value" id="add_sub_exp_value">
      <option value="1" selected="selected"><?php echo $this->_var['lang']['add']; ?></option>
      <option value="-1"><?php echo $this->_var['lang']['subtract']; ?></option>
    </select>
      <input name="exp_value" type="text" id="exp_value" style="text-align:right" value="0" size="10" />
      <?php echo $this->_var['lang']['current_value']; ?><?php echo $this->_var['user']['exp_value']; ?></td>
  </tr>
  <tr>
