  ...
  <form action="javascript:searchUser()" name="searchForm">
    ...
    <?php echo $this->_var['lang']['user_id']; ?> <input type="text" name="keyword" size="10" />
      <select name="process_type">
        ...
        <?php else: ?>
          <option value="2" <?php echo $this->_var['process_type_2']; ?>><?php echo $this->_var['lang']['surplus_type_2']; ?></option>
        <option value="3" <?php echo $this->_var['process_type_3']; ?>><?php echo $this->_var['lang']['surplus_type_3']; ?></option>
          <option value="3" <?php echo $this->_var['process_type_5']; ?>><?php echo $this->_var['lang']['surplus_type_5']; ?></option>
        <?php endif; ?>
      </select>
      <select name="payment">
...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <th><a href="javascript:listTable.sort('amount', 'DESC'); "><?php if ($this->_var['action'] == 'list'): ?><?php echo $this->_var['lang']['surplus_amount']; ?><?php else: ?><?php echo $this->_var['lang']['surplus_exp']; ?><?php endif; ?></a><?php echo $this->_var['sort_amount']; ?></th>
