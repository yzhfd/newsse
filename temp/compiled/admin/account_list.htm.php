...
<form method="post" action="account_log.php?act=list&user_id=<?php echo $_GET['user_id']; ?>" name="searchForm">
  <select name="account_type" onchange="document.forms['searchForm'].submit()">
    ...
    <option value="virtual_money" <?php if ($this->_var['account_type'] == 'virtual_money'): ?>selected="selected"<?php endif; ?>><?php echo $this->_var['lang']['virtual_money']; ?></option>
    <option value="exp_value" <?php if ($this->_var['account_type'] == 'exp_value'): ?>selected="selected"<?php endif; ?>><?php echo $this->_var['lang']['exp_value']; ?></option>
  </select>
  ...
  <strong><?php echo $this->_var['lang']['label_virtual_money']; ?></strong><?php echo $this->_var['user']['formated_frozen_money']; ?>
  <strong><?php echo $this->_var['lang']['label_exp_value']; ?></strong><?php echo $this->_var['user']['exp_value']; ?>
...
<?php endif; ?>
  ...
  <table cellpadding="3" cellspacing="1">
    <tr>
      ...
      <th><?php echo $this->_var['lang']['virtual_money']; ?></th>
      <th><?php echo $this->_var['lang']['exp_value']; ?></th>
...
?>
    <tr>
      ...
      <td align="right">
        <?php if ($this->_var['account']['virtual_money'] > 0): ?>
          <span style="color:#0000FF">+<?php echo $this->_var['account']['virtual_money']; ?></span>
        <?php elseif ($this->_var['account']['virtual_money'] < 0): ?>
          <span style="color:#FF0000"><?php echo $this->_var['account']['virtual_money']; ?></span>
        <?php else: ?>
          <?php echo $this->_var['account']['virtual_money']; ?>
        <?php endif; ?>
      </td>
      <td align="right">
        <?php if ($this->_var['account']['exp_value'] > 0): ?>
          <span style="color:#0000FF">+<?php echo $this->_var['account']['exp_value']; ?></span>
        <?php elseif ($this->_var['account']['exp_value'] < 0): ?>
          <span style="color:#FF0000"><?php echo $this->_var['account']['exp_value']; ?></span>
        <?php else: ?>
          <?php echo $this->_var['account']['exp_value']; ?>
        <?php endif; ?>
      </td>
      <td align="right">
