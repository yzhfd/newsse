...
<table border="0" width="100%">
  <tr>
    <td colspan="2"><strong><?php echo $this->_var['surplus_info']; ?>：</strong><hr /></td>
  </tr>
  <tr>
    <td colspan="2">
    <strong><?php echo $this->_var['lang']['user_id']; ?>：</strong><?php echo $this->_var['user_name']; ?> &nbsp;&nbsp;<strong><?php echo $this->_var['surplus_amount']; ?>：</strong><?php echo $this->_var['surplus']['amount']; ?> &nbsp;&nbsp;<strong><?php echo $this->_var['lang']['add_date']; ?>：</strong><?php echo $this->_var['surplus']['add_time']; ?>
