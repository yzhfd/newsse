...
<?php echo $this->smarty_insert_scripts(array('files'=>'../js/utils.js,selectzone.js,colorselector.js,../js/transport.js,../js/region.js')); ?>
                ...
                <?php endif; ?>
                  <tr>
                    ...
                    <td><select name="user_id" id="user_id">
                            <option value="0"><?php echo $this->_var['lang']['suppliers_no']; ?></option>
                            <?php echo $this->html_options(array('options'=>$this->_var['suppliers_users'],'selected'=>$this->_var['goods']['user_id'])); ?>
                        </select></td>
                </tr>
                <tr>
...
?>
                ...
                <tr>
                    <td class="label"><?php echo $this->_var['lang']['lab_goods_virtual']; ?></td>
                    <td><input type="text" name="goods_virtual" value="<?php echo $this->_var['goods']['goods_virtual']; ?>" size="20" />
                    </td>
                </tr>
                <tr>
                    <td class="label"><?php echo $this->_var['lang']['lab_goods_exp']; ?></td>
                    <td><input type="text" name="goods_exp" value="<?php echo $this->_var['goods']['goods_exp']; ?>" size="20" />
                    </td>
                </tr>
                <tr>
                    <td class="label"><?php echo $this->_var['lang']['lab_goods_newer']; ?></td>
                    <td><input type="text" name="goods_newer" value="<?php echo $this->_var['goods']['goods_newer']; ?>" size="20" />
                    </td>
                </tr>
                  <tr>
                    <td class="label"><?php echo $this->_var['lang']['lab_goods_standard']; ?></td>
                    <td><input type="text" name="goods_standard" value="<?php echo $this->_var['goods']['goods_standard']; ?>" size="20" />
                    </td>
                </tr>
                <tr>
                    <td class="label"><?php echo $this->_var['lang']['lab_goods_flaw']; ?></td>
                    <td>
                        <textarea name="goods_flaw"><?php echo $this->_var['goods']['goods_flaw']; ?></textarea>
                    </td>
                </tr>
                <tr>
                    <td class="label"><?php echo $this->_var['lang']['lab_is_local']; ?></td>
                    <td><input type="checkbox" name="is_local" id="is_local" <?php if ($this->_var['goods']['is_local']): ?>checked<?php endif; ?> onchange="local_change(this);" value="1" size="20" />
                    </td>
                </tr>
                <tr id="local_area1">
                    <td>&nbsp;</td>
                    <td id="regionCell" align="left">
...
?>
                            <input type="checkbox" name="local_area[]" value="<?php echo $this->_var['id']; ?>" checked="true" /> <?php echo $this->_var['region']; ?>&nbsp;&nbsp;
                           <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                    </td>
                </tr>
                <tr id="local_area" <?php if (! $this->_var['goods']['is_local']): ?>style="display:none;"<?php endif; ?>>
                    <td class="label"><?php echo $this->_var['lang']['lab_local_area']; ?></td>
                    <td>
...
?>
                ...
                <tr id="local_des" <?php if (! $this->_var['goods']['is_local']): ?>style="display:none;"<?php endif; ?>>
                    <td class="label"><?php echo $this->_var['lang']['lab_local_des']; ?></td>
                    <td>
                        <textarea name="local_des"><?php echo $this->_var['goods']['local_des']; ?></textarea>
                    </td>
                </tr>
                <tr>
...
?>
            ...
            function addRegion()
            {
                ...
                if (!exists)
                {
                    regionCell.innerHTML += "<input type='checkbox' name='local_area[]' value='" + regionId + "' checked='true' /> " + regionName + "&nbsp;&nbsp;";
                }
            }
            function local_change(input){
                var local_area1= document.getElementById('local_area1');
                var local_area= document.getElementById('local_area');
                var local_des= document.getElementById('local_des');
                if(input.checked){
                    local_area1.style.display="";
                    local_area.style.display="";
                    local_des.style.display="";
                }else{
                    local_area1.style.display="none";
                    local_area.style.display="none";
                    local_des.style.display="none";
                }
            }
...
?>
                ...
                /* 锟斤拷锟界换锟斤拷锟姐�锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷��拷锟斤拷锟斤拷锟�/
