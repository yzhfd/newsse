...
?>
      ...
      <?php else: ?>
      <strong><?php echo $this->_var['lang']['goods_standard']; ?></strong><?php echo $this->_var['goods']['goods_standard']; ?>
      <?php endif; ?>
       </dd>
       <dd class="ddR">
...
<!--      <li class="clearfix">
       <dd>
           经验值
      <strong><?php echo $this->_var['lang']['need_exp']; ?></strong><?php echo $this->_var['goods']['goods_exp']; ?>
       </dd>
       <dd class="ddR">
       <strong><?php echo $this->_var['lang']['goods_virtual']; ?>：</strong><?php echo $this->_var['goods']['goods_virtual']; ?>
       </dd>
      </li>-->
       <li class="clearfix">
       <dd>
           
      <strong><?php echo $this->_var['lang']['goods_newer']; ?></strong><?php echo $this->_var['goods']['goods_newer']; ?>
       </dd>
       <dd class="ddR">
       
       <strong><?php echo $this->_var['lang']['goods_flaw']; ?></strong><?php echo $this->_var['goods']['goods_flaw']; ?>
       </dd>
      </li>
      <li class="clearfix">
       <dd class="ddL">
...
?>
      ...
      <?php endif; ?>
     <?php if ($this->_var['goods']['is_local']): ?>
      <li class="padd loop" style="margin-bottom:5px; border-bottom:1px dashed #ccc;">
      <strong><?php echo $this->_var['lang']['local_area']; ?></strong>
      <?php echo $this->_var['regions']; ?>
      </li>
      <?php endif; ?>
