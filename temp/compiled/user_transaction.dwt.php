...
?>
         ...
         <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
          ...
          <tr>
            <td align="right" bgcolor="#ffffff">
              ...
              <?php endif; ?>
                <?php if ($this->_var['order']['money'] > 0): ?>
              - <?php echo $this->_var['lang']['use_money']; ?>: <?php echo $this->_var['order']['formated_money']; ?>
              <?php endif; ?>
    ...
    <?php endif; ?>
        ...
        <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
              ...
              <select name="pay_id">
                <?php $_from = $this->_var['payment_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'payment_0_90855500_1359878059');if (count($_from)):
    foreach ($_from AS $this->_var['payment_0_90855500_1359878059']):
?>
                <option value="<?php echo $this->_var['payment_0_90855500_1359878059']['pay_id']; ?>">
                <?php echo $this->_var['payment_0_90855500_1359878059']['pay_name']; ?>(<?php echo $this->_var['lang']['pay_fee']; ?>:<?php echo $this->_var['payment_0_90855500_1359878059']['format_pay_fee']; ?>)
                </option>
                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
              </select>
...
<!--           <a href="user.php?act=account_transfer" class="f6"><?php echo $this->_var['lang']['surplus_type_2']; ?></a> | -->
      ...
      <?php if ($this->_var['action'] == "aaccount_log" || $this->_var['action'] == "exp_value_buy" || $this->_var['action'] == "exp_value_sell" || $this->_var['action'] == "exp_value_exchange"): ?>
        <script type="text/javascript">
          <?php $_from = $this->_var['lang']['account_js']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item']):
?>
        ...
        <h5><span><?php echo $this->_var['lang']['user_exp']; ?></span></h5>
        <div class="blank"></div>
         <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
          <tr>
            <td align="right" bgcolor="#ffffff">
                <a href="user.php?act=exp_value_exchange" class="f6"><?php echo $this->_var['lang']['surplus_type_5']; ?></a> | 
                <a href="user.php?act=exp_value_sell" class="f6"><?php echo $this->_var['lang']['surplus_type_4']; ?></a> | 
                <a href="user.php?act=exp_value_buy" class="f6"><?php echo $this->_var['lang']['surplus_type_3']; ?></a> | 
<!--           <a href="user.php?act=account_transfer" class="f6"><?php echo $this->_var['lang']['surplus_type_2']; ?></a> | -->
            <a href="user.php?act=aaccount_log" class="f6"><?php echo $this->_var['lang']['view_application']; ?></a> </td>
          </tr>
        </table>
        <?php endif; ?>
         <?php if ($this->_var['action'] == "exp_value_exchange"): ?>
        <form name="formSurplus" method="post" action="user.php" onSubmit="return submitSurplus()">
            <input type="hidden" id ="exp_exchange" value="<?php echo $this->_var['exp_exchange']; ?>"/>
        <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
          <tr>
            <td width="15%" bgcolor="#ffffff"><?php echo $this->_var['lang']['exp_value_exchange']; ?>:</td>
            <td bgcolor="#ffffff" align="left"><input type="text" onblur="changeExchange(this.value)" name="amount" value="" class="inputBg" size="30" />
            </td>
          </tr>
           <tr>
            <td width="15%" bgcolor="#ffffff"><?php echo $this->_var['lang']['exp_exchange_exp']; ?>:</td>
            <td bgcolor="#ffffff" align="left"><input type="text" id="exchange_exp" value="0" readonly="true" class="inputBg" size="30" />
            </td>
          </tr>
            <tr>
            <td width="15%" bgcolor="#ffffff"><?php echo $this->_var['lang']['exp_exchange_money']; ?>:</td>
            <td bgcolor="#ffffff" align="left"><input type="text" id="exchange_money" value="0" readonly="true" class="inputBg" size="30" />
            </td>
          </tr>
          <tr>
            <td bgcolor="#ffffff"><?php echo $this->_var['lang']['process_notic']; ?>:</td>
            <td bgcolor="#ffffff" align="left"><textarea name="user_note" cols="55" rows="6" style="border:1px solid #ccc;"></textarea></td>
          </tr>
...
?>
        ...
        <script type="text/javascript">
              ...
              function changeExchange(val){
                  if(val){
                      var exp_sell= document.getElementById('exp_exchange').value;
                      var exp_sell_money=document.getElementById('exchange_money');
                      var exp_sell_exp=document.getElementById('exchange_exp');
                      exp_sell_money.value=val*exp_sell;
                      exp_sell_exp.value=val*exp_sell;
                  }
              }
              
            </script>
        <?php endif; ?>
       <?php if ($this->_var['action'] == "account_transfer"): ?>
        <form name="formSurplus" method="post" action="user.php" onSubmit="return submitSurplus()">
        <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
           <tr>
            <td width="15%" bgcolor="#ffffff"><?php echo $this->_var['lang']['tranfer_to']; ?>:</td>
            <td bgcolor="#ffffff" align="left"><input type="text" name="username" value="" class="inputBg" size="15" />
            </td>
          </tr>
          <tr>
            <td width="15%" bgcolor="#ffffff"><?php echo $this->_var['lang']['tranfer_value']; ?>:</td>
            <td bgcolor="#ffffff" align="left"><input type="text" name="amount" value="" class="inputBg" size="30" />
            </td>
          </tr>
          <tr>
            <td bgcolor="#ffffff"><?php echo $this->_var['lang']['process_notic']; ?>:</td>
        ...
        <?php endif; ?>
        <?php if ($this->_var['action'] == "exp_value_buy"): ?>
        <form name="formSurplus" method="post" action="user.php" onSubmit="return submitSurplus()">
            <input type="hidden" id ="exp_buy" value="<?php echo $this->_var['exp_buy']; ?>"/>
        <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
          <tr>
            <td width="15%" bgcolor="#ffffff"><?php echo $this->_var['lang']['exp_value_buy']; ?>:</td>
            <td bgcolor="#ffffff" align="left"><input type="text" onblur="changeBuy(this.value)" name="amount" value="" class="inputBg" size="30" />
            </td>
          </tr>
            <tr>
            <td width="15%" bgcolor="#ffffff"><?php echo $this->_var['lang']['exp_buy_money']; ?>:</td>
            <td bgcolor="#ffffff" align="left"><input type="text" id="buy_money" value="0" readonly="true" class="inputBg" size="30" />
            </td>
          </tr>
          <tr>
            <td bgcolor="#ffffff"><?php echo $this->_var['lang']['process_notic']; ?>:</td>
...
?>
        ...
        <script type="text/javascript">
              ...
              function changeBuy(val){
                  if(val){
                      var exp_sell= document.getElementById('exp_buy').value;
                      var exp_sell_money=document.getElementById('buy_money');
                      exp_sell_money.value=val*exp_sell;
                  }
              }
        ...
        <?php endif; ?>
               <?php if ($this->_var['action'] == "exp_value_sell"): ?>
        <form name="formSurplus" method="post" action="user.php" onSubmit="return submitSurplus()">
             <input type="hidden" id ="exp_sell" value="<?php echo $this->_var['exp_sell']; ?>"/>
        <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
          <tr>
            <td width="15%" bgcolor="#ffffff"><?php echo $this->_var['lang']['exp_value_sell']; ?>:</td>
            <td bgcolor="#ffffff" align="left"><input type="text" name="amount" onblur="changeSell(this.value)" value="" class="inputBg" size="30" />
            </td>
          </tr>
             <tr>
            <td width="15%" bgcolor="#ffffff"><?php echo $this->_var['lang']['exp_sell_money']; ?>:</td>
            <td bgcolor="#ffffff" align="left"><input type="text" id="sell_money" value="0" readonly="true" class="inputBg" size="30" />
            </td>
          </tr>
          <tr>
            <td bgcolor="#ffffff"><?php echo $this->_var['lang']['process_notic']; ?>:</td>
          ...
          <script type="text/javascript">
              ...
              function changeSell(val){
                  if(val){
                      var exp_sell= document.getElementById('exp_sell').value;
                      var exp_sell_money=document.getElementById('sell_money');
                      exp_sell_money.value=val*exp_sell;
                  }
              }
...
?>
          <tr>
            ...
            <td align="right" bgcolor="#ffffff"><?php echo $this->_var['item']['handle']; ?>
              <?php if (( $this->_var['item']['is_paid'] == 0 && $this->_var['item']['process_type'] == 1 ) || $this->_var['item']['handle'] || ( $this->_var['item']['is_paid'] == 0 && $this->_var['item']['process_type'] == 2 )): ?>
      ...
      <?php endif; ?>
        ...
        <?php if ($this->_var['action'] == "aaccount_log"): ?>
        <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
          <tr align="center">
            <td bgcolor="#ffffff"><?php echo $this->_var['lang']['process_time']; ?></td>
            <td bgcolor="#ffffff"><?php echo $this->_var['lang']['surplus_pro_type']; ?></td>
...
?>
          ...
          <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
          <tr>
            <td colspan="7" align="right" bgcolor="#ffffff"><?php echo $this->_var['lang']['current_exp']; ?><?php echo $this->_var['surplus_amount']; ?></td>
          </tr>
        </table>
        <?php echo $this->fetch('library/pages.lbi'); ?>
      <?php endif; ?>
