...
<a href="user.php?act=supply_list"<?php if ($this->_var['action'] == 'supply_list'): ?>class="curs"<?php endif; ?>><img src="themes/default/images/u3.gif"> <?php echo $this->_var['lang']['label_record']; ?></a>
<a href="user.php?act=goods_sell"<?php if ($this->_var['action'] == 'goods_sell'): ?>class="curs"<?php endif; ?>><img src="themes/default/images/u3.gif"> <?php echo $this->_var['lang']['label_sell']; ?></a>
...
<a href="user.php?act=aaccount_log"<?php if ($this->_var['action'] == 'aaccount_log'): ?>class="curs"<?php endif; ?>><img src="themes/default/images/u13.gif"> <?php echo $this->_var['lang']['label_user_exp']; ?></a>
