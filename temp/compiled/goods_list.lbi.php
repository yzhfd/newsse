<div class="box">
 <div class="box_1">
  ...
  <?php echo $this->_var['lang']['btn_display']; ?>£º
...
?>
    ...
    <li>
    <br>
    <a href="javascript:;" id="compareLink" onClick="Compare.add(<?php echo $this->_var['goods']['goods_id']; ?>,'<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>','<?php echo $this->_var['goods']['type']; ?>')" class="f6">±È½Ï</a>
    </li>
