...
elseif ($_REQUEST['act'] == 'insert')
{
    ...
    {
        log_account_change($_SESSION['user_id'], 0, 0, 0,0,$GLOBALS['_CFG']['register_points'], $GLOBALS['_CFG']['register_points'], $_LANG['register_points']);
    }
...
elseif ($_REQUEST['act'] == 'edit')
{
    ...
    $sql = "SELECT u.user_name, u.sex, u.birthday, u.pay_points, u.rank_points, u.user_rank , u.user_money, u.frozen_money, u.virtual_money,u.exp_value,u.credit_line, u.parent_id, u2.user_name as parent_username, u.qq, u.msn, u.office_phone, u.home_phone, u.mobile_phone".
    ...
    $sql = "SELECT u.user_id, u.sex, u.birthday, u.pay_points, u.rank_points, u.user_rank , u.user_money, u.frozen_money,u.virtual_money,u.exp_value, u.credit_line, u.parent_id, u2.user_name as parent_username, u.qq, u.msn,
    ...
    if ($row)
    {
        ...
        $user['virtual_money'] =$row['virtual_money'];
        $user['exp_value']=$row['exp_value'];
        ...
        $user['formated_virtual_money'] = price_format($row['virtual_money']);
...
function user_list()
{
    ...
    if ($result === false)
    {
        ...
        $sql = "SELECT user_id, user_name, email, is_validated, user_money, frozen_money,virtual_money,exp_value, rank_points, pay_points, reg_time ".
