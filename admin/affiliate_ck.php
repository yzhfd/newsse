...
elseif ($_REQUEST['act'] == 'rollback')
{
    ...
    if (!empty($stat))
    {
        ...
        log_account_change($stat['user_id'], -$stat['money'], 0, 0,0,-$stat['point'], 0, $_LANG['loginfo']['cancel']);
    ...
    if (empty($row['is_separate']))
    {
        ...
        if(empty($separate_by))
        {
            ...
            for ($i=0; $i < $num; $i++)
            {
                ...
                else
                {
                    ...
                    log_account_change($up_uid, $setmoney, 0, 0,0,$setpoint, 0, $info);
        ...
        else
        {
            ...
            if(!empty($up_uid) && $up_uid > 0)
            {
                ...
                log_account_change($up_uid, $money, 0,0,0, $point, 0, $info);
